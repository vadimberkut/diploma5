...
public static class DehazeDarkChannel
{
    ...
    public static int estimateA(Image<Gray, byte> DC)
    {
        double[] minDC, maxDC;
    ...
    public static Image<Gray, Byte> estimateTransmission(Image<Gray, Byte> DCP, int ac)
    {
        double w = 0.75;
    ...
    public static Image<Bgr, Byte> getDehazed(Image<Bgr, Byte> source, Image<Gray, Byte> t, int al)
    {
        double tmin = 0.1;
        double tmax;
